...
::grpc::Status RGBCameraService::Stub::GetRGBCameraImageData(::grpc::ClientContext* context, const ::VCCSim::RobotName& request, ::VCCSim::RGBCameraImageData* response) {
  return ::grpc::internal::BlockingUnaryCall< ::VCCSim::RobotName, ::VCCSim::RGBCameraImageData, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetRGBCameraImageData_, context, request, response);
}

void RGBCameraService::Stub::async::GetRGBCameraImageData(::grpc::ClientContext* context, const ::VCCSim::RobotName* request, ::VCCSim::RGBCameraImageData* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::VCCSim::RobotName, ::VCCSim::RGBCameraImageData, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetRGBCameraImageData_, context, request, response, std::move(f));
}

void RGBCameraService::Stub::async::GetRGBCameraImageData(::grpc::ClientContext* context, const ::VCCSim::RobotName* request, ::VCCSim::RGBCameraImageData* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::VCCSim::RGBCameraImageData>* RGBCameraService::Stub::PrepareAsyncGetRGBCameraImageDataRaw(::grpc::ClientContext* context, const ::VCCSim::RobotName& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::VCCSim::RGBCameraImageData, ::VCCSim::RobotName, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetRGBCameraImageData_, context, request);
}

::grpc::ClientAsyncResponseReader< ::VCCSim::RGBCameraImageData>* RGBCameraService::Stub::AsyncGetRGBCameraImageDataRaw(::grpc::ClientContext* context, const ::VCCSim::RobotName& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
RGBCameraService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< RGBCameraService::Service, ::VCCSim::RobotName, ::VCCSim::RGBCameraImageData, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](RGBCameraService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::VCCSim::RobotName* req,
...
::grpc::Status RGBCameraService::Service::GetRGBCameraImageData(::grpc::ServerContext* context, const ::VCCSim::RobotName* request, ::VCCSim::RGBCameraImageData* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
